! function(j, q, L, N) {
    "use strict";
    q = void 0 !== q && q.Math == Math ? q : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), j.fn.fzmodal = function(w) {
        var C, e = j(this),
            F = j(q),
            M = j(L),
            x = j("body"),
        ...
        return e.each(function() {
            var i, t, e, o, a, n, r, s, c, l = j.isPlainObject(w) ? j.extend(!0, {}, j.fn.fzmodal.settings, w) : j.extend({}, j.fn.fzmodal.settings),
                d = l.selector,
                u = l.className,
                m = l.namespace,
                f = l.error,
            ...
            c = {
                ...
                instantiate: function() {
                    c.verbose("Storing instance of fzmodal"), k = c, v.data(h, k)
                },
                create: {
                    dimmer: function() {
                        var e = {
                ...
                destroy: function() {
                    c.verbose("Destroying previous fzmodal"), v.removeData(h).off(g), F.off(n), a.off(n), p.off(g), b.dimmer("destroy")
                },
                ...
                refresh: function() {
                    c.remove.scrolling(), c.cacheSizes(), c.can.useFlex() || c.set.fzmodalOffset(), c.set.screenHeight(), c.set.type()
                },
                refreshModals: function() {
                    t = v.siblings(d.fzmodal), i = t.add(v)
                },
                attachEvents: function(e, n) {
                    var i = j(e);
                    n = j.isFunction(c[n]) ? c[n] : c.toggle, 0 < i.length ? (c.debug("Attaching fzmodal events to element", e, n), i.off(g).on("click" + g, n)) : c.error(f.notFound, e)
                },
                bind: {
                    events: function() {
                ...
                event: {
                    ...
                    click: function(e) {
                        if (l.closable) {
                            var n = 0 < j(e.target).closest(d.fzmodal).length,
                                i = j.contains(L.documentElement, e.target);
                            !n && i && c.is.active() && (c.debug("Dimmer clicked, hiding all fzmodals"), c.remove.clickaway(), l.allowMultiple ? c.hide() : c.hideAll())
                    ...
                    keyboard: function(e) {
                        27 == e.which && (l.closable ? (c.debug("Escape key pressed hiding fzmodal"), c.hide()) : c.debug("Escape key pressed, but closable is set to false"), e.preventDefault())
                    },
                    resize: function() {
                ...
                showModal: function(e) {
                    e = j.isFunction(e) ? e : function() {}, c.is.animating() || !c.is.active() ? (c.showDimmer(), c.cacheSizes(), c.can.useFlex() ? c.remove.legacy() : (c.set.legacy(), c.set.fzmodalOffset(), c.debug("Using non-flex legacy fzmodal positioning.")), c.set.screenHeight(), c.set.type(), c.set.clickaway(), !l.allowMultiple && c.others.active() ? c.hideOthers(c.showModal) : (l.allowMultiple && l.detachable && v.detach().appendTo(a), l.onShow.call(y), l.transition && j.fn.transition !== N && v.transition("is supported") ? (c.debug("Showing fzmodal with css animations"), v.transition({
                        debug: l.debug,
                ...
                hideModal: function(e, n) {
                    e = j.isFunction(e) ? e : function() {}, c.debug("Hiding fzmodal"), !1 !== l.onHide.call(y, j(this)) ? (c.is.animating() || c.is.active()) && (l.transition && j.fn.transition !== N && v.transition("is supported") ? (c.remove.active(), v.transition({
                        debug: l.debug,
                ...
                hideAll: function(e) {
                    ...
                    e = j.isFunction(e) ? e : function() {}, 0 < n.length && (c.debug("Hiding all visible fzmodals"), c.hideDimmer(), n.fzmodal("hide fzmodal", e))
                },
                hideOthers: function(e) {
                    var n = t.filter("." + u.active + ", ." + u.animating);
                    e = j.isFunction(e) ? e : function() {}, 0 < n.length && (c.debug("Hiding other fzmodals", t), n.fzmodal("hide fzmodal", e, !0))
                },
                others: {
                    active: function() {
                ...
                cacheSizes: function() {
                    ...
                    }, c.cache.topOffset = -c.cache.height / 2), v.removeClass(u.loading), c.debug("Caching fzmodal and container sizes", c.cache)
                },
                can: {
                    useFlex: function() {
                ...
                set: {
                    ...
                    fzmodalOffset: function() {
                        var e = c.cache.width,
                            n = c.cache.height;
                        v.css({
                            marginTop: l.centered && c.can.fit() ? -n / 2 : 0,
                            marginLeft: -e / 2
                        }), c.verbose("Setting fzmodal offset for legacy mode")
                    },
                    screenHeight: function() {
