/* @preserve skinview3d / MIT License / https://github.com/bs-community/skinview3d */ ! function(e, t) {
    ...
    class Fe {
        ...
        distanceSqToSegment(e, t, i, n) {
            ...
            else d <= -p ? (h = Math.max(0, -(-a * r + s)), d = h > 0 ? -r : Math.min(Math.max(-r, -o), r), u = -h * h + d * (d + 2 * o) + l) : d <= p ? (h = 0, d = Math.min(Math.max(-r, -o), r), u = d * (d + 2 * o) + l) : (h = Math.max(0, -(a * r + s)), d = h > 0 ? r : Math.min(Math.max(-r, -o), r), u = -h * h + d * (d + 2 * o) + l);
    ...
    class it extends D {
        constructor() {
            super(), Object.defineProperty(this, "id", {
                value: We++
            }), this.uuid = z(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = it.DefaultUp.clone();
            const e = new ee,
                t = new ke,
                i = new $,
                n = new ee(1, 1, 1);
    ...
    class mt extends D {
        constructor() {
            super(), Object.defineProperty(this, "id", {
                value: ft++
            }), this.uuid = z(), this.name = "", this.type = "Material", this.fog = !0, this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.format = A, this.transparent = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = l, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = C, this.stencilZFail = C, this.stencilZPass = C, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0
        }
        get alphaTest() {
    ...
    class At {
        ...
        applyMatrix3(e) {
            if (2 === this.itemSize)
                for (let t = 0, i = this.count; t < i; t++) Tt.fromBufferAttribute(this, t), Tt.applyMatrix3(e), this.setXY(t, Tt.x, Tt.y);
    ...
    class zt extends D {
        ...
        setIndex(e) {
            return Array.isArray(e) ? this.index = new(V(e) > 65535 ? Lt : Et)(e, 1) : this.index = e, this
        }
        getAttribute(e) {
        ...
        applyMatrix4(e) {
            ...
            if (void 0 !== i) {
                const t = (new W).getNormalMatrix(e);
    ...
    class ti extends it {
        ...
        raycast(e, t) {
            const i = this.geometry,
                ...
                r = this.matrixWorld;
            if (void 0 === n) return;
            if (null === i.boundingSphere && i.computeBoundingSphere(), Gt.copy(i.boundingSphere), Gt.applyMatrix4(r), !1 === e.ray.intersectsSphere(Gt)) return;
    ...
    function ii(e, t, i, n, r, a, s, o, l, c, h, d) {
        kt.fromBufferAttribute(r, c), Ht.fromBufferAttribute(r, h), Wt.fromBufferAttribute(r, d);
        ...
        if (a && u) {
            ...
            for (let e = 0, t = a.length; e < t; e++) {
                const t = u[e],
                    i = a[e];
                0 !== t && (Vt.fromBufferAttribute(i, c), Xt.fromBufferAttribute(i, h), Yt.fromBufferAttribute(i, d), s ? (jt.addScaledVector(Vt, t), Qt.addScaledVector(Xt, t), qt.addScaledVector(Yt, t)) : (jt.addScaledVector(Vt.sub(kt), t), Qt.addScaledVector(Xt.sub(Ht), t), qt.addScaledVector(Yt.sub(Wt), t)))
            }
            kt.add(jt), Ht.add(Qt), Wt.add(qt)
        }
        e.isSkinnedMesh && (e.boneTransform(c, kt), e.boneTransform(h, Ht), e.boneTransform(d, Wt));
        ...
        if (p) {
            o && (Zt.fromBufferAttribute(o, c), Jt.fromBufferAttribute(o, h), Kt.fromBufferAttribute(o, d), p.uv = pt.getUV($t, kt, Ht, Wt, Zt, Jt, Kt, new H)), l && (Zt.fromBufferAttribute(l, c), Jt.fromBufferAttribute(l, h), Kt.fromBufferAttribute(l, d), p.uv2 = pt.getUV($t, kt, Ht, Wt, Zt, Jt, Kt, new H));
            const e = {
                a: c,
                b: h,
                c: d,
            ...
            pt.getNormal(kt, Ht, Wt, e.normal), p.face = e
        }
        return p
    }
    ...
    class ci extends li {
        ...
        updateProjectionMatrix() {
            const e = this.near;
            let t = e * Math.tan(.5 * R * this.fov) / this.zoom,
                i = 2 * t,
                n = this.aspect * i,
                r = -.5 * n;
            const a = this.view;
    ...
    const wi = {
        ...
        Ai = {
            ...
            toon: {
                uniforms: ai([Ti.common, Ti.aomap, Ti.lightmap, Ti.emissivemap, Ti.bumpmap, Ti.normalmap, Ti.displacementmap, Ti.gradientmap, Ti.fog, Ti.lights, {
                    emissive: {
                        value: new bt(0)
                    }
                }]),
    ...
    class qi {
        ...
        _sceneToCubeUV(e, t, i, n) {
            ...
            p ? p.isColor && (h.color.copy(p), e.background = null, u = !0) : (h.color.copy(Vi), u = !0);
            for (let t = 0; t < 6; t++) {
                const i = t % 3;
        ...
        _textureToCubeUV(e, t) {
            ...
            const r = n ? this._cubemapShader : this._equirectShader,
                a = new ti(ki[0], r),
                s = r.uniforms;
            s.envMap.value = e, n || s.texelSize.value.set(1 / e.image.width, 1 / e.image.height), this._setEncoding(s.inputEncoding, e), Ki(t, 0, 0, 3 * Ri, 2 * Ri), i.setRenderTarget(t), i.render(a, Gi)
        }
        _applyPMREM(e) {
            ...
            t.autoClear = !1;
            for (let t = 1; t < zi; t++) {
                const i = Math.sqrt(Wi[t] * Wi[t] - Wi[t - 1] * Wi[t - 1]),
                    n = Qi[(t - 1) % Qi.length];
        ...
        _halfBlur(e, t, i, n, r, a, s) {
            ...
            const x = Hi[n];
            Ki(t, 3 * Math.max(0, Ri - 2 * x), (0 === n ? 0 : 2 * Ri) + 2 * x * (n > 4 ? n - 8 + 4 : 0), 3 * x, 2 * x), o.setRenderTarget(t), o.render(c, Gi)
        }
    }
    ...
    function sn(e, t, i, n) {
        ...
        function o(e) {
            ...
            const o = new(V(i) > 65535 ? Lt : Et)(i, 1);
            o.version = s;
            const l = a.get(e);
    ...
    function on(e, t, i, n) {
        ...
        this.setMode = function(e) {
            ...
            else if (h = t.get("ANGLE_instanced_arrays"), d = "drawElementsInstancedANGLE", null === h) return void console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");
    ...
    function ra(e, t, i) {
        ...
        let A = !1,
            E = 0;
        const L = e.getParameter(7938); - 1 !== L.indexOf("WebGL") ? (E = parseFloat(/^WebGL (\d)/.exec(L)[1]), A = E >= 1) : -1 !== L.indexOf("OpenGL ES") && (E = parseFloat(/^OpenGL ES (\d)/.exec(L)[1]), A = E >= 2);
        let P = null,
            F = {};
        ...
        U[3553] = R(3553, 3553, 1), U[34067] = R(34067, 34069, 6), r.setClear(0, 0, 0, 1), a.setClear(1), s.setClear(0), z(2929), a.setFunc(3), H(!1), W(1), z(2884), k(0);
        const B = {
            [l]: 32774,
            101: 32778,
            102: 32779
        ...
        function k(t, i, n, r, a, s, o, c) {
            if (0 !== t) {
                if (!1 === d && (z(3042), d = !0), 5 === t) a = a || i, s = s || n, o = o || r, i === p && a === g || (e.blendEquationSeparate(B[i], B[a]), p = i, g = a), n === f && r === m && s === x && o === _ || (e.blendFuncSeparate(G[n], G[r], G[s], G[o]), f = n, m = r, x = s, _ = o), u = t, v = null;
                else if (t !== u || c !== v) {
        ...
        return {
            ...
            setMaterial: function(e, t) {
                ...
                let i = 1 === e.side;
                t && (i = !i), H(i), 1 === e.blending && !1 === e.transparent ? k(0) : k(e.blending, e.blendEquation, e.blendSrc, e.blendDst, e.blendEquationAlpha, e.blendSrcAlpha, e.blendDstAlpha, e.premultipliedAlpha), a.setFunc(e.depthFunc), a.setTest(e.depthTest), a.setMask(e.depthWrite), r.setMask(e.colorWrite);
                const n = e.stencilWrite;
                s.setTest(n), n && (s.setMask(e.stencilWriteMask), s.setFunc(e.stencilFunc, e.stencilRef, e.stencilFuncMask), s.setOp(e.stencilFail, e.stencilZFail, e.stencilZPass)), V(e.polygonOffset, e.polygonOffsetFactor, e.polygonOffsetUnits), !0 === e.alphaToCoverage ? z(32926) : O(32926)
            },
            setFlipSided: H,
            setCullFace: W,
        ...
        function K(t, n, r) {
            ...
            if (n.isDepthTexture) _ = 6402, o ? _ = n.type === b ? 36012 : n.type === M ? 33190 : n.type === w ? 35056 : 33189 : n.type === b && console.error("WebGLRenderer: Floating point depth texture requires WebGL2."), n.format === E && 6402 === _ && n.type !== y && n.type !== M && (console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."), n.type = y, m = a.convert(n.type)), n.format === L && 6402 === _ && (_ = 34041, n.type !== w && (console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."), n.type = w, m = a.convert(n.type))), S && P ? i.texStorage2D(3553, 1, _, c.width, c.height) : i.texImage2D(3553, 0, _, c.width, c.height, 0, u, m, null);
                ...
                if (v.length > 0 && d) {
                    ...
                    n.generateMipmaps = !1
                } else S ? (P && i.texStorage2D(3553, F, _, c.width, c.height), i.texSubImage2D(3553, 0, 0, 0, c.width, c.height, u, m, c.data)) : i.texImage2D(3553, 0, _, c.width, c.height, 0, u, m, c.data);
            ...
            } else if (n.isDataTexture2DArray) S ? (P && i.texStorage3D(35866, F, _, c.width, c.height, c.depth), i.texSubImage3D(35866, 0, 0, 0, 0, c.width, c.height, c.depth, u, m, c.data)) : i.texImage3D(35866, 0, _, c.width, c.height, c.depth, 0, u, m, c.data);
            else if (n.isDataTexture3D) S ? (P && i.texStorage3D(32879, F, _, c.width, c.height, c.depth), i.texSubImage3D(32879, 0, 0, 0, 0, c.width, c.height, c.depth, u, m, c.data)) : i.texImage3D(32879, 0, _, c.width, c.height, c.depth, 0, u, m, c.data);
            ...
            if (t.depthTexture && !r.__autoAllocateDepthBuffer) {
                ...
                ! function(t, r) {
                    ...
                    const a = n.get(r.depthTexture).__webglTexture,
                        s = ie(r);
                    if (r.depthTexture.format === E) r.useRenderToTexture ? u.framebufferTexture2DMultisampleEXT(36160, 36096, 3553, a, 0, s) : e.framebufferTexture2D(36160, 36096, 3553, a, 0);
                    else {
        ...
        constructor(e, t) {
            ...
            function D() {
                _.forEach((function(e, t) {
                    e.disconnect(t)
                })), _.clear(), F = null, C = null, e.setRenderTarget(m), d = null, h = null, c = null, n = null, g = null, B.stop(), i.isPresenting = !1, i.dispatchEvent({
                    type: "sessionend"
                })
            }
                ...
                if (n = l, null !== n) {
                    if (m = e.getRenderTarget(), n.addEventListener("select", N), n.addEventListener("selectstart", N), n.addEventListener("selectend", N), n.addEventListener("squeeze", N), n.addEventListener("squeezestart", N), n.addEventListener("squeezeend", N), n.addEventListener("end", D), n.addEventListener("inputsourceschange", I), !0 !== f.xrCompatible && await t.makeXRCompatible(), void 0 === n.renderState.layers || !1 === e.capabilities.isWebGL2) {
                        ...
                        d = new XRWebGLLayer(n, t, i), n.updateRenderState({
                            baseLayer: d
                        }), g = new J(d.framebufferWidth, d.framebufferHeight, {
                            format: A,
                            type: v,
                        ...
                        const l = {
                            colorFormat: f.alpha || u ? 32856 : 32849,
                            depthFormat: s,
                            scaleFactor: r
                        };
                        c = new XRWebGLBinding(n, t), h = c.createProjectionLayer(l), n.updateRenderState({
                            layers: [h]
                        }), g = u ? new K(h.textureWidth, h.textureHeight, {
                            format: A,
                            type: v,
                    ...
                    this.setFoveation(1), a = await n.requestReferenceSpace(s), B.setContext(n), B.start(), i.isPresenting = !0, i.dispatchEvent({
                        type: "sessionstart"
                    })
                }
            };
    ...
    function fa(e = {}) {
        ...
        this.domElement = t, this.debug = {
            checkShaderErrors: !0
        }, this.autoClear = !0, this.autoClearColor = !0, this.autoClearDepth = !0, this.autoClearStencil = !0, this.sortObjects = !0, this.clippingPlanes = [], this.localClippingEnabled = !1, this.outputEncoding = P, this.physicallyCorrectLights = !1, this.toneMapping = 0, this.toneMappingExposure = 1;
        const x = this;
        let y = !1,
            M = 0,
            w = 0,
        ...
        function Ae() {
            te = new an(we), ie = new Fi(we, te, e), te.init(ie), be = new sa(we, te, ie), ne = new ra(we, te, ie), k[0] = 1029, re = new ln(we), ae = new Vr, se = new aa(we, te, ne, ae, ie, be, re), oe = new Ni(x), le = new rn(x), ce = new bi(we, ie), Se = new Li(we, te, ce, ie), he = new sn(we, ce, re, Se), de = new fn(we, he, ce, re), ve = new pn(we, ie, se), ge = new Ci(ae), ue = new Wr(x, oe, le, te, ie, Se, ge), pe = new pa(ae), fe = new Qr, me = new ea(te, ie), _e = new Ei(x, oe, ne, de, o), xe = new na(x, de, ie), ye = new Pi(we, te, re, ie), Me = new on(we, te, re, ie), re.programs = ue.programs, x.capabilities = ie, x.extensions = te, x.properties = ae, x.renderLists = fe, x.shadowMap = xe, x.state = ne, x.info = re
        }
        Ae();
        ...
        function Ge(e, t, i) {
            ...
            const d = n.uniforms;
            (e.isShaderMaterial || e.isRawShaderMaterial) && !0 !== e.clipping || (d.clippingPlanes = ge.uniform), ke(e, o), n.needsLights = function(e) {
        ...
        Re.setAnimationLoop((function(e) {
            ...
            if (!0 === y) return;
            !0 === e.autoUpdate && e.updateMatrixWorld(), null === t.parent && t.updateMatrixWorld(), !0 === Ee.enabled && !0 === Ee.isPresenting && (!0 === Ee.cameraAutoUpdate && Ee.updateCamera(t), t = Ee.getCamera()), !0 === e.isScene && e.onBeforeRender(x, e, t, T), u = me.get(e, m.length), u.init(), m.push(u), j.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), H.setFromProjectionMatrix(j), V = this.localClippingEnabled, W = ge.init(this.clippingPlanes, V, t), d = fe.get(e, p.length), d.init(), p.push(d), Ue(e, t, 0, x.sortObjects), d.finish(), !0 === x.sortObjects && d.sort(U, z), !0 === W && ge.beginShadows();
            const i = u.state.shadowsArray;
            if (xe.render(i, e, t), !0 === W && ge.endShadows(), !0 === this.info.autoReset && this.info.reset(), _e.render(d, e), u.setupLights(x.physicallyCorrectLights), t.isArrayCamera) {
                const i = t.cameras;
                for (let t = 0, n = i.length; t < n; t++) {
                    const n = i[t];
                    ze(d, e, n, n.viewport)
            ...
            } else F.copy(O).multiplyScalar(R).floor(), C.copy(B).multiplyScalar(R).floor(), N = G;
            if (ne.bindFramebuffer(36160, r) && ie.drawBuffers && n) {
                ...
                t && (ie.isWebGL2 ? we.drawBuffers(k) : te.get("WEBGL_draw_buffers").drawBuffersWEBGL(k))
            }
    ...
    class za extends la {
        constructor(e, t) {
            super(), this.skin = new Ia(e), this.skin.name = "skin", this.skin.position.y = 8, this.add(this.skin), this.cape = new Ra(t), this.cape.name = "cape", this.cape.position.y = 8, this.cape.position.z = -2, this.cape.rotation.x = 10.8 * Math.PI / 180, this.cape.rotation.y = Math.PI, this.add(this.cape), this.elytra = new Ua(t), this.elytra.name = "elytra", this.elytra.position.y = 8, this.elytra.position.z = -2, this.elytra.visible = !1, this.add(this.elytra)
        }
        get backEquipment() {
    ...
    function ka(e, t, i) {
        if (i) {
            if (Ba(e, 0, 0, t, t)) return
        } else if (Ba(e, 0, 0, t, t / 2)) return;
        const n = Ga(t),
    ...
    function Ha(e, t) {
        ...
        } else e.width = t.width, e.height = t.height, n.clearRect(0, 0, t.width, t.height), n.drawImage(t, 0, 0, e.width, e.height), ka(n, e.width, !0)
    }
    ...
    class Ya {
        ...
        play(e, t) {
            if (this.toResetAndRemove) return Xa(this.animation, e, 0), void this.remove();
            let i;
            this.started ? i = t - this.lastTime : (i = 0, this.started = !0), this.lastTime = t, this.paused || (this.progress += i * this.speed), Xa(this.animation, e, this.progress)
        }
        reset() {
            this.progress = 0
        }
    ...
    class qa {
        constructor(e = {}) {
            this.animations = new Qa, this.globalLight = new Aa(16777215, .4), this.cameraLight = new Ta(16777215, .6), this.backgroundTexture = null, this._disposed = !1, this._renderPaused = !1, this.canvas = void 0 === e.canvas ? document.createElement("canvas") : e.canvas, this.skinCanvas = document.createElement("canvas"), this.skinTexture = new Q(this.skinCanvas), this.skinTexture.magFilter = g, this.skinTexture.minFilter = g, this.capeCanvas = document.createElement("canvas"), this.capeTexture = new Q(this.capeCanvas), this.capeTexture.magFilter = g, this.capeTexture.minFilter = g, this.scene = new ma, this.camera = new ci, this.camera.add(this.cameraLight), this.scene.add(this.camera), this.scene.add(this.globalLight), this.renderer = new fa({
                canvas: this.canvas,
                alpha: !1 !== e.alpha,
                preserveDrawingBuffer: !0 === e.preserveDrawingBuffer
            }), this.renderer.setPixelRatio(window.devicePixelRatio), this.playerObject = new za(this.skinTexture, this.capeTexture), this.playerObject.name = "player", this.playerObject.skin.visible = !1, this.playerObject.cape.visible = !1, this.playerWrapper = new la, this.playerWrapper.add(this.playerObject), this.scene.add(this.playerWrapper), void 0 !== e.skin && this.loadSkin(e.skin, e.model), void 0 !== e.cape && this.
            
            (e.cape), void 0 !== e.width && (this.width = e.width), void 0 !== e.height && (this.height = e.height), void 0 !== e.background && (this.background = e.background), void 0 !== e.panorama && this.loadPanorama(e.panorama), this.camera.position.z = 1, this._zoom = void 0 === e.zoom ? .9 : e.zoom, this.fov = void 0 === e.fov ? 50 : e.fov, !0 === e.renderPaused ? (this._renderPaused = !0, this.animationID = null) : this.animationID = window.requestAnimationFrame(() => this.draw()), this.onContextLost = e => {
        ...
        loadSkin(e, t = "auto-detect", i = {}) {
            if (null === e) this.resetSkin();
                ...
                if (!Oa(e)) return Va(e).then(e => this.loadSkin(e, t, i)); {
                    Ha(this.skinCanvas, e);
                    const n = "auto-detect" === t ? function(e) {
                        const t = Ga(e.width),
                            i = e.getContext("2d"),
                            n = (e, n, r, a) => Ba(i, e * t, n * t, r * t, a * t),
        ...
        loadCape(e, t = {}) {
            if (null === e) this.resetCape();
                ...
                if (!Oa(e)) return Va(e).then(e => this.loadCape(e, t));
        ...
        loadBackground(e, t) {
            if (!Oa(e)) return Va(e).then(e => this.loadBackground(e, t));
    ...
    class $a extends D {
        constructor(e, l) {
            super(), void 0 === l && console.warn('THREE.OrbitControls: The second parameter "domElement" is now mandatory.'), l === document && console.error('THREE.OrbitControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.'), this.object = e, this.domElement = l, this.domElement.style.touchAction = "none", this.enabled = !0, this.target = new ee, this.minDistance = 0, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.enableDamping = !1, this.dampingFactor = .05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = {
                ...
                c.target.copy(c.target0), c.object.position.copy(c.position0), c.object.zoom = c.zoom0, c.object.updateProjectionMatrix(), c.dispatchEvent(Za), c.update(), d = h.NONE
            ...
            function B() {
                if (1 === E.length) _.set(E[0].pageX, E[0].pageY);
                    ...
                    const e = .5 * (E[0].pageX + E[1].pageX),
                        t = .5 * (E[0].pageY + E[1].pageY);
                    _.set(e, t)
                }
            }
                        ...
                        case 2:
                            switch (c.touches.TWO) {
                                case s:
                                    ...
                                    c.enableZoom && k(), c.enablePan && G(), d = h.TOUCH_DOLLY_PAN;
                                    break;
                                case o:
                                    if (!1 === c.enableZoom && !1 === c.enableRotate) return;
                                    c.enableZoom && k(), c.enableRotate && B(), d = h.TOUCH_DOLLY_ROTATE;
                                    break;
                                default:
                                    d = h.NONE
                            }
                ...
                !1 !== c.enabled && ("touch" === e.pointerType ? function(e) {
                    switch (ie(e), d) {
                        ...
                        case h.TOUCH_DOLLY_PAN:
                            if (!1 === c.enableZoom && !1 === c.enablePan) return;
                            ! function(e) {
                                c.enableZoom && X(e), c.enablePan && V(e)
                            }(e), c.update();
                            break;
                        case h.TOUCH_DOLLY_ROTATE:
                            if (!1 === c.enableZoom && !1 === c.enableRotate) return;
                            ! function(e) {
                                c.enableZoom && X(e), c.enableRotate && W(e)
                            }(e), c.update();
                            break;
                        default:
                            d = h.NONE
            ...
            function Q(e) {
                te(e), 0 === E.length && (c.domElement.releasePointerCapture(e.pointerId), c.domElement.removeEventListener("pointermove", j), c.domElement.removeEventListener("pointerup", Q)), c.dispatchEvent(Ka), d = h.NONE
            }
            ...
            function Z(e) {
                !1 !== c.enabled && !1 !== c.enableZoom && d === h.NONE && (e.preventDefault(), c.dispatchEvent(Ja), function(e) {
                    e.deltaY < 0 ? U(P()) : e.deltaY > 0 && R(P()), c.update()
                }(e), c.dispatchEvent(Ka))
            }
            ...
            function te(e) {
                ...
                for (let t = 0; t < E.length; t++)
                    if (E[t].pointerId == e.pointerId) return void E.splice(t, 1)
            }
    ...
    const is = new Di(-1, 1, 1, -1, 0, 1),
        ns = new zt;
    ns.setAttribute("position", new Pt([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)), ns.setAttribute("uv", new Pt([0, 2, 0, 0, 2, 0], 2));
    class rs {
        constructor(e) {
            this._mesh = new ti(ns, e)
        }
        dispose() {
            this._mesh.geometry.dispose()
        }
        render(e) {
            e.render(this._mesh, is)
        }
        get material() {
    ...
    class as extends ts {
        constructor(e, t) {
            ...
            })), this.fsQuad = new rs(this.material)
        }
        render(e, t, i) {
    ...
    class ls {
        constructor(e, t) {
            ...
            this.renderTarget1 = t, this.renderTarget2 = t.clone(), this.renderTarget2.texture.name = "EffectComposer.rt2", this.writeBuffer = this.renderTarget1, this.readBuffer = this.renderTarget2, this.renderToScreen = !0, this.passes = [], void 0 === es && console.error("THREE.EffectComposer relies on CopyShader"), void 0 === as && console.error("THREE.EffectComposer relies on ShaderPass"), this.copyPass = new as(es), this.clock = new Ea
        }
        swapBuffers() {
        ...
        render(e) {
            ...
            for (let t = 0, n = this.passes.length; t < n; t++) {
                ...
                if (!1 !== n.enabled) {
                    ...
                    void 0 !== ss && (n instanceof ss ? i = !0 : n instanceof os && (i = !1))
                }
            }
    ...
    new Di(-1, 1, 1, -1, 0, 1);
    const cs = new zt;
    cs.setAttribute("position", new Pt([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)), cs.setAttribute("uv", new Pt([0, 2, 0, 0, 2, 0], 2));
    class hs extends ts {
    ...
    e.BodyPart = Da, e.CapeObject = Ra, e.CompositeAnimation = ja, e.ElytraObject = Ua, e.FXAASkinViewer = class extends qa {
        constructor(e) {
            void 0 === e ? e = {
                alpha: !1,
                background: "white"
            } : (e.alpha = !1, void 0 === e.background && (e.background = "white")), super(e), this.composer = new ls(this.renderer), this.renderPass = new hs(this.scene, this.camera), this.fxaaPass = new as(ds), this.composer.addPass(this.renderPass), this.composer.addPass(this.fxaaPass), this.updateComposerSize(), this.renderer.setClearColor("white")
        }
        setSize(e, t) {
    ...
    }, e.PlayerObject = za, e.RootAnimation = Qa, e.RotatingAnimation = (e, t) => {
        e.rotation.y = t
    ...
    }, e.SkinObject = Ia, e.SkinViewer = qa, e.WalkingAnimation = (e, t) => {
        const i = e.skin;
        ...
        const t = new $a(e.camera, e.renderer.domElement);
        return t.enablePan = !1, t.target = new ee(0, 0, 0), t.minDistance = 10, t.maxDistance = 256, t.update(), t
    }, e.invokeAnimation = Xa, Object.defineProperty(e, "__esModule", {
        value: !0
    })
